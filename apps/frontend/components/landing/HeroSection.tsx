...
export function HeroSection() {
  return (
    <section className="relative bg-cyan-500 text-white pt-24 pb-20 lg:pt-32 lg:pb-28 overflow-hidden">
      {/* Ocean blue background with subtle gradient overlay */}
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button asChild variant="outline" size="lg" className="text-base border-white/30 text-white hover:bg-cyan-400">
