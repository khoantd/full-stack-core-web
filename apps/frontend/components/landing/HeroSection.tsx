...
export function HeroSection() {
  return (
    <section className="relative bg-pink-500 text-gray-900 pt-24 pb-20 lg:pt-32 lg:pb-28 overflow-hidden">
      {/* Pink background with subtle pattern overlay */}
      <div className="absolute inset-0 bg-pink-500" />
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto">
          <p className="text-sm font-medium text-pink-900 uppercase tracking-wider mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="text-base bg-gray-900 text-pink-500 hover:bg-gray-800">
              <Link href="/#products">Products</Link>
            </Button>
            <Button asChild variant="outline" size="lg" className="text-base border-gray-900/30 text-gray-900 hover:bg-pink-400">
