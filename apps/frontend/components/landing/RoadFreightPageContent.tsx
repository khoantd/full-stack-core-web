...
const SERVICES = [
  {
    ...
    desc: "Dedicated truck capacity for large shipments. Direct routes with no stops, ensuring faster delivery and reduced handling.",
  },
  {
    icon: Package,
    title: "Less Than Truckload (LTL)",
    desc: "Cost-effective solution for smaller freight. Share truck space with other shippers and only pay for what you use.",
  },
  {
    icon: Globe,
    title: "Cross-Border Freight",
    desc: "Seamless international road freight with full customs clearance support and compliance documentation.",
  },
  {
    icon: Zap,
    title: "Express Road Delivery",
    desc: "Time-critical shipments handled with priority routing and guaranteed delivery windows.",
  },
  {
    icon: Shield,
    title: "Hazardous Goods Transport",
    desc: "Certified handling of dangerous goods with full regulatory compliance and trained drivers.",
  },
  {
    icon: HeadphonesIcon,
    title: "24/7 Freight Support",
    desc: "Round-the-clock operations team monitoring every shipment and ready to resolve any issue instantly.",
  },
];
...
const PROCESS = [
  {
    ...
    desc: "Fill in your shipment details and get an instant competitive quote tailored to your freight needs.",
  },
  {
    step: "02",
    title: "Schedule Pickup",
    desc: "Choose your preferred pickup date and time. Our driver arrives at your location ready to load.",
  },
  {
    step: "03",
    title: "Real-Time Tracking",
    desc: "Monitor your freight every mile of the journey with live GPS tracking and status updates.",
  },
  {
    step: "04",
    title: "Safe Delivery",
    desc: "Your cargo arrives on time and in perfect condition, with proof of delivery confirmation.",
  },
];

const FAQS = [
  {
    q: "What types of freight can you transport?",
    a: "We handle all types of road freight including general cargo, palletized goods, oversized loads, temperature-sensitive shipments, and hazardous materials with full compliance.",
  },
  {
    q: "How do I track my shipment?",
    a: "Every shipment gets a unique tracking number. Use our online portal or mobile app for real-time GPS tracking, estimated arrival times, and delivery notifications.",
  },
  {
    q: "Do you offer cross-border road freight?",
    a: "Yes. We operate cross-border routes with dedicated customs brokers handling all documentation, duties, and compliance requirements for smooth border crossings.",
  },
  {
    q: "What is the difference between FTL and LTL?",
    a: "FTL (Full Truckload) gives you exclusive use of an entire truck — ideal for large shipments. LTL (Less Than Truckload) lets you share truck space with other shippers, reducing costs for smaller loads.",
  },
  {
    q: "How are freight rates calculated?",
    a: "Rates depend on weight, dimensions, distance, freight class, and any special handling requirements. Get an instant quote through our online tool or contact our team.",
  },
];
  ...
  return (
    <>
      ...
      <section className="relative bg-[#111111] py-20 overflow-hidden">
        ...
        <div className="absolute right-0 bottom-0 opacity-5 text-[200px] leading-none select-none pointer-events-none">
          🚛
        </div>
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-gray-400 max-w-xl mb-6">
            Reliable, cost-effective road freight solutions connecting businesses across the country and beyond.
          </p>
          <nav className="flex items-center gap-2 text-sm text-gray-400">
            ...
            <ChevronRight className="h-3.5 w-3.5" />
            <span className="text-orange-500">Road Freight</span>
          </nav>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-6 leading-tight">
                We Get Your Cargo Where It Needs to Go
              </h2>
              <p className="text-gray-400 mb-5 leading-relaxed">
                With a fleet of 150+ modern trucks and 25 years of road freight expertise, we deliver
                reliable transport solutions for businesses of all sizes. From local deliveries to
                long-haul cross-border shipments, we've got the network and the know-how.
              </p>
              <p className="text-gray-400 mb-8 leading-relaxed">
                Our drivers are fully certified, our vehicles are GPS-tracked, and every shipment is
                covered by comprehensive cargo insurance. We don't just move freight — we move it safely,
                on time, every time.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-400 mt-4 max-w-xl mx-auto">
              From single pallets to full truckloads, we offer a complete range of road freight services tailored to your business.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {SERVICES.map(({ icon: Icon, title, desc }) => (
              ...
              >
                <div className="w-14 h-14 rounded bg-orange-500/10 flex items-center justify-center mb-5 group-hover:bg-orange-500 transition">
                  <Icon className="h-7 w-7 text-orange-500 group-hover:text-white transition" />
                </div>
                <h3 className="text-white font-bold text-lg mb-3">{title}</h3>
                <p className="text-gray-400 text-sm leading-relaxed mb-5">{desc}</p>
                <Link
                  href="/#contact"
                  className="inline-flex items-center gap-1.5 text-orange-500 text-sm font-semibold hover:gap-3 transition-all"
                >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {PROCESS.map(({ step, title, desc }, i) => (
              <div key={step} className="relative">
                {/* Connector line */}
                {i < PROCESS.length - 1 && (
                  <div className="hidden lg:block absolute top-8 left-full w-full h-px bg-orange-500/20 z-0" style={{ width: "calc(100% - 4rem)", left: "4rem" }} />
                )}
                <div className="relative z-10">
                  <div className="w-16 h-16 rounded-full bg-orange-500/10 border-2 border-orange-500/30 flex items-center justify-center mb-5">
                    <span className="text-orange-500 font-extrabold text-lg">{step}</span>
                  </div>
                  <h3 className="text-white font-bold text-lg mb-3">{title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-8 leading-tight">
                The Fastest & Most Reliable Road Freight
              </h2>
                ...
                {FAQS.map(({ q, a }, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {openFaq === i ? (
                        <Minus className="h-4 w-4 text-orange-500 shrink-0" />
                      ) : (
          ...
          <div className="bg-orange-500 rounded-2xl px-8 py-14 flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="text-center lg:text-left">
              ...
              <p className="text-orange-100 mt-3 max-w-xl">
                Get a free quote in minutes. Our team is available 24/7 to plan your road freight shipment and ensure it arrives on time.
              </p>
            </div>
