    ...
    <section id="blog" className="py-20 bg-[#0d0d0d]">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          {BLOG_POSTS.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-white font-bold text-lg mb-3 leading-snug group-hover:text-orange-500 transition-colors line-clamp-2">
                  {post.title}
                </h3>
        ...
        <div className="text-center mt-12">
          <Link
            href="/blog"
            className="inline-flex items-center gap-2 border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white font-semibold px-8 py-3 rounded transition"
          >
            View All Posts
            <ArrowRight className="h-4 w-4" />
          </Link>
