...
interface FaqSectionTableProps {
  data: FaqSection[];
  actions: {
    onView: (section: FaqSection) => void;
...
export function FaqSectionTable({ data, actions, searchValue, onSearchChange }: FaqSectionTableProps) {
  const t = useTranslations("pages.faqSections.table");
  ...
  const columns: ColumnDef<FaqSection>[] = [
    {
      accessorKey: "title",
      header: ({ column }) => (
        ...
        return (
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => actions.onDelete(section)} className="text-destructive">
