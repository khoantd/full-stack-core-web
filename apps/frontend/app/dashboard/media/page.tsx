...
import { Search, Upload, Trash2, Copy, Image, FileText, Video, File } from "lucide-react";
...
export default function MediaLibraryPage() {
  ...
  const { data, isLoading, isError } = useMediaFiles(type !== "all" ? type : undefined);
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
              {files.map(file => {
                ...
                return (
                  <div key={file.key} className="group relative rounded-lg border bg-muted/30 overflow-hidden hover:border-primary transition-colors">
